...
class BookingServiceImplTest {
    ...
    void createBooking_whenValidData_thenSavedBooking() {
        ...
        when(userMapper.dtoToUser(any())).thenReturn(user);
    ...
    void findBookingById_whenBookingNotFound_thenNotFoundExceptionThrown() {
        ...
        assertEquals("Бронирование с таким id не найдено", notFoundException.getMessage());
    }
    ...
    void findBookingById_whenUserIsNeitherOwnerNorBooker_thenNotFoundExceptionThrown() {
        ...
        assertEquals("Попытка поиска бронирование пользователем, не являющимся владельцем или бронирующим",
