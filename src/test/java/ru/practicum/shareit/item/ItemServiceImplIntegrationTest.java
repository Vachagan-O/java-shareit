...
class ItemServiceImplIntegrationTest {
    ...
    void findItemById() {
        ...
        ItemWithDateAndCommentsDto targetItem = service.getItemById(user.getId(), entityId);
    ...
    void findItemsByUserId() {
        ...
        List<ItemWithDateAndCommentsDto> targetItems = service.getAllItemsByUserId(user.getId(), 0, 10);
