...
class ItemControllerITest {
    ...
    void findItemById() {
        ...
        verify(itemService).getItemById(userId, itemDto.getId());
    }
    ...
    void findItemsByUserId() {
        Long userId = 1L;
        when(itemService.getAllItemsByUserId(any(), any(), any())).thenReturn(Collections.emptyList());
        ...
        verify(itemService).getAllItemsByUserId(userId, 1, 10);
    }
